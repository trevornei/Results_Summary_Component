...
export default function ResultsCont() {
  return (
    <>
        <div className="flex flex-col bg-gradient-to-b from-violet-600 to-violet-800 w-full h-full md:rounded-bl-none md:rounded-r-xl sm:rounded-b-xl my-18 mx-18 p-12 ">
